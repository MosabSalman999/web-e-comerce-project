...
<head>
    ...
    <style>
        ...
        form {
            ...
            margin-bottom: 30px;
            max-width: 500px;
            text-align: left; /* Aligns content inside form to the left */
            margin: 20px auto; /* Centers the form itself horizontally */
        }
        ...
        form button {
            display: block;         /* Makes it take full width of the line */
